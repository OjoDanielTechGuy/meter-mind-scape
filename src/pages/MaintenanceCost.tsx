...
const maintenanceItems = [
  ...
  { 
    ...
    task: "Panel Cleaning & Inspection", 
    status: "scheduled", 
    dueDate: "Dec 20, 2024", 
    cost: 200,
    priority: "medium"
  ...
  { 
    ...
    task: "Firmware Update & Calibration", 
    status: "completed", 
    dueDate: "Dec 5, 2024", 
    cost: 150,
    priority: "low"
  ...
  { 
    id: 4, 
    equipment: "Building A Meter", 
    task: "Sensor Replacement", 
    status: "due", 
    dueDate: "Dec 12, 2024", 
    cost: 320,
    priority: "high"
  ...
  { 
    id: 5, 
    equipment: "Generator Unit B", 
    task: "Coolant System Service", 
    status: "scheduled", 
    dueDate: "Dec 25, 2024", 
    cost: 380,
    priority: "medium"
...
const MaintenanceCost = () => {
  ...
  const getStatusBadge = (status: string) => {
    switch (status) {
      case "due":
        return <Badge variant="destructive" className="gap-1"><AlertTriangle className="h-3 w-3" /> Due</Badge>;
      case "scheduled":
        return <Badge variant="secondary" className="gap-1 bg-warning/20 text-warning border-warning/30"><Clock className="h-3 w-3" /> Scheduled</Badge>;
      case "completed":
        return <Badge variant="secondary" className="gap-1 bg-success/20 text-success border-success/30"><CheckCircle2 className="h-3 w-3" /> Completed</Badge>;
      default:
        return null;
    }
  };
